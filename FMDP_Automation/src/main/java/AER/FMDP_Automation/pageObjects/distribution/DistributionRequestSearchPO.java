...
public class DistributionRequestSearchPO 
{
	WebDriver driver;
	...
	public DistributionRequestSearchPO(WebDriver driver)
	{	 
        this.driver = driver;
	 ...
	 */ 
		...
		//Search Criteria Section :	
			...
			@FindBy(id="txtDistributionRequestId")
			private WebElement distributionRequestId;
