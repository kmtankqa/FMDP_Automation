...
public class DistributionRequestTests
{
	...
	private int executeonhour_create = Integer.parseInt(JavaHelpers.getPropertyValue(propertyFile, "executeonhour_create"));
	private int executeonminute_create = Integer.parseInt(JavaHelpers.getPropertyValue(propertyFile, "executeonminute_create"));
	...
	private String usedataimportedhour_create = JavaHelpers.getPropertyValue(propertyFile, "usedataimportedhour_create");
	...
	public void supplier_Add() throws IOException {
		try {
			...
			ftptype = "ftp";
			distributionrequestsetupadd.distributionRequest_GeneraDetails_Add(recipient_create, executeonhour_create, executeonminute_create, exportformat_create, flighttype_create, usedataimportedhour_create, filename, faretype_create, source_create, officeid_create, corporatecode_create);
			distributionrequestsetupadd.distributionRequest_FlightDetails_Add(airlines_create, excludeairline_create, maxfare_create, minfare_create, maxlayover_create, minlayover_create, exportformat_create, flighttype_create);
			distributionrequestsetupadd.distributionRequest_FTPAndEDFPathDetails_Add(ftptype, ftplocation_create, ftpusername_create, ftppassword_create);
